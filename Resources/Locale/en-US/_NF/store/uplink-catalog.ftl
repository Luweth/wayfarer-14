...
uplink-security-speedloaderbox-desc = A revolver speed loader that comes pre-loaded with .45 pistol cartridges.

uplink-security-speedloaderrubberbox-name = .45 Pistol Rubber Speed Loaders
uplink-security-speedloaderrubberbox-desc = A revolver speed loader that comes pre-loaded with .45 rubber cartridges.
